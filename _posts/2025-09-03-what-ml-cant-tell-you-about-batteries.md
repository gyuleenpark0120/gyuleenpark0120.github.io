...
date: 2025-09-03
description: ML predicts and optimizes. But the mechanistic understanding that makes battery research actually work lives in text — and that's a structural gap pure data-driven approaches can't close.
...
<div class="paper-header">
  ...
  <p class="paper-tldr">Severson predicts; Attia optimizes. But mechanistic understanding — the part that makes battery research actually progress — lives in the text of papers, not in cycling numbers. This is the structural gap pure data-driven approaches can't close.</p>
</div>
...
All of this context — decades of experimental results, mechanistic interpretations, failure mode analyses — is accumulated in the scientific literature. ML, as practiced in Severson and Attia, doesn't read it.
...
The next two posts are about papers that started building exactly that.
