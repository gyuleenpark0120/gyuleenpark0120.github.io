...
description: >
  ...
  and DFT-derived descriptors to electrochemical performance. Led Samsung SDI collaborative
...
**Carbon-Host and Interphase Strategies**
Developed carbon-host architectures as structured lithium deposition scaffolds, combining materials design with characterization-informed structure-property analysis. Integrated multi-technique characterization to map how host geometry and surface chemistry influence nucleation/growth behavior and long-term cyclability.

**Characterization-Informed Mechanistic Understanding**
Applied a broad suite of characterization techniques to connect interfacial structure with electrochemical performance:

- **Structural/chemical**: XRD, XPS, ToF-SIMS, EDS
- **Morphological**: SEM, FIB-SEM, TEM, AFM
- **Spectroscopic**: Raman, FT-IR, NMR
...
`Electrolyte Design` `SEI/CEI Interphase Engineering` `Solvation Behavior` `DFT-Derived Molecular Descriptors` `HOMO/LUMO` `XPS` `SEM/FIB-SEM` `ToF-SIMS` `Raman` `NMR` `EIS` `Coin-Cell Fabrication` `Pouch-Cell Scale-Up`
